...
ggexport(distance_plots, filename = "W:/VF/Optimising_VF/Lameroo/plots_pre_RF/test_distance_plots.png")
ggexport(behaviour_plots, filename = "W:/VF/Optimising_VF/Lameroo/plots_pre_RF/test_behaviour_plots.png")
ggexport(cue_plots, filename = "W:/VF/Optimising_VF/Lameroo/plots_pre_RF/test_cue_plots.png")
ggexport(Mean_animals_close, filename = "W:/VF/Optimising_VF/Lameroo/plots_pre_RF/test_Mean_animals_close.png")
