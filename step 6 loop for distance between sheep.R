...
GPS_Sheep <- read_csv("W:/VF/Optimising_VF/Lameroo/data_prep/step5_Greg_time_step_dist_travelled.csv")
...
list_of_comparsions <- read_excel("W:/VF/Optimising_VF/Lameroo/data_prep/list of animal comparisons.xlsx", 
...
list_of_comparsions_x <- list_of_comparsions #I will use all the sheep no treatment grouping
...
write.csv(df, "W:/VF/Optimising_VF/Lameroo/data_prep/step6_dist_between_animals_matrix.csv")
